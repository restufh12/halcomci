        ...
        <div class="row">
			...
			<div class="col-lg-3 col-md-6 col-sm-6">
                <div class="footer_panel padding_bottom_half bottom20">
                    ...
                    <p class="whitecolor bottom25">The Central Business Sukajadi Blok B2 No 3A Batam Kepulauan Riau 29444, Indonesia</p>
                    <ul class="whitecolor">
                        <li><span><i class="fa fa-phone-square"></i></span> <span>+62 778-461503</span></li>
                        <li><span><i class="fa fa-envelope-square"></i></span> <span>sales@pt-halcom.com</span></li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-6">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center wow fadeIn animated" data-wow-delay="300ms">
                <p class="m-0 py-3">Copyright © <a href="javascript:void(0)" class="hover-default">Halcom Integrated Solution</a>. All Rights Reserved.</p>
            </div>
        </div>
    </div>
</div>