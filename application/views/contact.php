...
Batam - Kepulauan Riau 29444, Indonesia</p>
                        <p class="bottom10">+62 778 - 461503</p>
                    ...
                    <div class="heading-title  wow fadeInUp" data-wow-delay="300ms">
                        <form class="getin_form wow fadeInUp" data-wow-delay="400ms" onsubmit="return false;">
                            <div class="row px-2">
                                ...
                                <div class="col-md-12 col-sm-12">
                                    <button type="button" id="btn-send-email" class="button gradient-btn w-100" onclick="contact.fnSendEmailToAdmin()">Send</button>
                                </div>
                            </div>
                        </form>
                    </div>
            ...
            <div class="col-lg-3 col-md-3">
                <div class="widget text-center top60 w-100">
                    <div class="contact-box">
                        ...
                        <p class="bottom0"><a href="tel:+62778461503">+62 778-461503</a></p>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-3">
                <div class="widget text-center top60 w-100">
                    <div class="contact-box">
                        ...
                        <p class="bottom0">The Central Business Sukajadi</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-3">
                <div class="widget text-center top60 w-100">
                    <div class="contact-box">
                        ...
                        <p class="bottom0"><a href="mailto:sales@pt-halcom.com">sales@pt-halcom.com</a></p>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-3">
...
<div class="w-100">
    <div class="full-map">
		<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3989.0828513388533!2d104.03161631475375!3d1.1001449991975243!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31d98ecb036804c3%3A0x3ce8c64d1c18113c!2sPT.%20Halcom%20Integrated%20Solution%20(Batam)!5e0!3m2!1sen!2sid!4v1598275393882!5m2!1sen!2sid" width="100%" height="400px" frameborder="0" style="border:0;" allowfullscreen=""></iframe>
	</div>
</div>
<!-- map end -->